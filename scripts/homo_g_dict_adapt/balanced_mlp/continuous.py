...
def main(args):
    ...
    homo = OnlineHomomorphismGDict(experience, g, sample_actions, args.threshold_multiplier, args.threshold_minimum,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-experience", type=int, default=500)
    parser.add_argument("--threshold-multiplier", type=float, default=1)
    parser.add_argument("--threshold-minimum", type=int, default=50)
